        ...
        <div className="h-screen grid grid-cols-3 gap-4">
            ...
            <div className="grid place-items-center">
                <div className="w-full max-w-xs">
                    <form className="shadow-2xl rounded-3xl px-8 pt-6 pb-8 mb-4">
                        <div className="mb-4">
                        ...
                        <div className="grid grid-rows-2 gap-4">
                            ...
                            <button className="bg-gray-400 hover:bg-black text-white font-bold py-2 px-4 rounded-2xl focus:outline-none focus:shadow-outline">
