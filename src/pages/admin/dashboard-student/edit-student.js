...
export default function editStudent() {
    return (
        <div>
            <button className="btn hover:bg-gray-400 rounded-full" onClick={()=>document.getElementById('my_modal_5').showModal()}>
                <FontAwesomeIcon icon={faPenToSquare} /></button>
            <dialog id="my_modal_5" className="modal rounded-lg">
                <div>
