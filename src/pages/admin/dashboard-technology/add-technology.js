...
export default function addTechnology() {
    return (
        <div>
            <button className="btn hover:bg-blue-400 rounded-full" onClick={()=>document.getElementById('my_modal_9').showModal()}>
                <FontAwesomeIcon icon={faSquarePlus} /></button>
            <dialog id="my_modal_9" className="modal rounded-lg">
                <div>
                    <div className="modal-box">
                        <h3 className="font-bold text-lg">Add Technology</h3>
